///scr_MissionScript_Tutorial1
var _s=instance_create(0,0,obj_server)
with(_s){
GameSettings[? "IsMission"]=true
GameSettings[? "MissionID"]=MissionID.Tutorial1
...
repeat(3){ds_list_add(_inst.DeckList,UnitID.Unturned_Zombie)}
...
_tut.TutorialScript=scr_campaign_con_tutorial_1
